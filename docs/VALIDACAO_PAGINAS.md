...
- Preencher formulário:
  - Nome: "Professor Teste Validação"
  - Email: "professor.teste.validacao@escola.com"
  - Senha: "teste123"
  - Matrícula: "PROF-2024-VALIDACAO"
...
**Erros no Console**:
- `Failed to load resource: 404` para `/rest/v1/teachers`
...
**Erros no Console**:
- `Failed to load resource: 404` para `/rest/v1/classrooms`
- Fallback para `turmas` também retorna 404 (tabela não existe)

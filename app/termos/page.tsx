      ...
      <main className="flex-1 px-4 py-4 overflow-y-auto">
        <div className="flex flex-col gap-6 max-w-2xl mx-auto pb-8">
          <div className="rounded-xl bg-white/5 border border-white/10 p-6">
            <h2 className="text-white text-xl font-bold mb-4">Termos de Serviço</h2>
            <p className="text-gray-400 text-xs mb-6">Última atualização: {new Date().toLocaleDateString('pt-BR')}</p>

            <div className="flex flex-col gap-6">
              <section>
                <h3 className="text-white text-base font-semibold mb-2">1. Aceitação dos Termos</h3>
              ...
              <section>
                <h3 className="text-white text-base font-semibold mb-2">2. Uso do Serviço</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
              ...
              <section>
                <h3 className="text-white text-base font-semibold mb-2">3. Conta do Usuário</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
              ...
              <section>
                <h3 className="text-white text-base font-semibold mb-2">4. Conteúdo do Usuário</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
              ...
              <section>
                <h3 className="text-white text-base font-semibold mb-2">5. Propriedade Intelectual</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
              ...
              <section>
                <h3 className="text-white text-base font-semibold mb-2">6. Limitação de Responsabilidade</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
              ...
              <section>
                <h3 className="text-white text-base font-semibold mb-2">7. Modificações dos Termos</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
              ...
              <section>
                <h3 className="text-white text-base font-semibold mb-2">8. Contato</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
